...
internal static class ExtractionReviewPersistenceServiceTests
{
    ...
    public static void LoadEditAndSaveReviewArtifactPersistsSurveyMetadataAndAdjacentOwners()
    {
        ...
        document.Parties[0].LotNumber = "Lot 4";
        document.Parties[0].Address = "4 King Street";
        document.Parties[0].LandValuationNumber = "16505005181";
        document.Parties[0].ExaminationNumber = "100000564";
        document.Parties[0].Volume = "314";
        document.Parties[0].Folio = "72";
        document.Representatives[0].ReviewNotes = "Confirmed from plan title block.";
        document.Representatives[0].LotNumber = "Lot Rep";
        document.Representatives[0].Address = "Representative address";
        document.Representatives[0].LandValuationNumber = "16505005182";
        document.Representatives[0].ExaminationNumber = "100000565";
        document.Representatives[0].Volume = "315";
        document.Representatives[0].Folio = "73";
        ...
        TestAssert.Equal("Lot 4", reloaded.Parties[0].LotNumber, "Edited party lot number should persist.");
        TestAssert.Equal("4 King Street", reloaded.Parties[0].Address, "Edited party address should persist.");
        TestAssert.Equal("16505005181", reloaded.Parties[0].LandValuationNumber, "Edited party LandVal No. should persist.");
        TestAssert.Equal("100000564", reloaded.Parties[0].ExaminationNumber, "Edited party exam number should persist.");
        TestAssert.Equal("314", reloaded.Parties[0].Volume, "Edited party volume should persist.");
        TestAssert.Equal("72", reloaded.Parties[0].Folio, "Edited party folio should persist.");
        ...
        TestAssert.Equal("Lot Rep", reloaded.Representatives[0].LotNumber, "Edited representative lot number should persist.");
        TestAssert.Equal("Representative address", reloaded.Representatives[0].Address, "Edited representative address should persist.");
        TestAssert.Equal("16505005182", reloaded.Representatives[0].LandValuationNumber, "Edited representative LandVal No. should persist.");
        TestAssert.Equal("100000565", reloaded.Representatives[0].ExaminationNumber, "Edited representative exam number should persist.");
        TestAssert.Equal("315", reloaded.Representatives[0].Volume, "Edited representative volume should persist.");
        TestAssert.Equal("73", reloaded.Representatives[0].Folio, "Edited representative folio should persist.");
