...
public sealed class PreflightRuleCatalogLoader
{
    ...
    private static readonly IReadOnlyList<PreflightRuleDefinition> DefaultRules = new[]
    {
        ...
        new PreflightRuleDefinition("dimension_source_presence", "dimension", "dimension", "Dimension source presence", "A computation sheet or configured spatial line source must be available before Validate Points and Lines can begin.", true, "blocker", true, SourceRoles: new[] { "computation_sheet", "coordinate_text_source" }),
