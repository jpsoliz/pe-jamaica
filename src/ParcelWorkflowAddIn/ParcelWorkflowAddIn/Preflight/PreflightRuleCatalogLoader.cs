...
public sealed class PreflightRuleCatalogLoader
{
    ...
    {
        new PreflightRuleDefinition("detected_profile_presence", "manifest", "Detected profile present", "Detected intake profile must be present before preflight can continue.", true, "blocker", true),
