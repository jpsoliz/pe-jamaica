...
public sealed class PreflightRuleCatalogLoader
{
    ...
    private static readonly IReadOnlyList<PreflightRuleDefinition> DefaultRules = new[]
    {
        ...
        new PreflightRuleDefinition("pxa_memorandum_detected", "memorandum", "survey_plan_memorandum", "Memorandum text detected", "PE/PXA survey-plan memorandum rules apply only when the source document contains MEMORANDUM text.", true, "configured", false, StageId: "data_extraction", WorkflowEffect: "info", EvaluatorKey: "pxa_memorandum_detected", TransactionTypeProfiles: new[] { "pe", "pxa" }, DocumentProfiles: new[] { "scanned_single_parcel_survey_plan_pdf", "survey_plan_pdf" }),
        new PreflightRuleDefinition("pxa_memorandum_surveyed_for_names_present", "memorandum", "survey_plan_memorandum", "Survey made at the instance of", "Detected memorandum should list the party at whose instance the survey was made or surveyed for.", true, "configured", false, StageId: "validate_points_and_lines", WorkflowEffect: "requires_disposition", EvaluatorKey: "pxa_memorandum_surveyed_for_names_present", TransactionTypeProfiles: new[] { "pe", "pxa" }),
        new PreflightRuleDefinition("pxa_memorandum_surveyed_property_name_present", "memorandum", "survey_plan_memorandum", "Surveyed property name", "Detected memorandum should list the name of the surveyed property.", true, "configured", false, StageId: "validate_points_and_lines", WorkflowEffect: "requires_disposition", EvaluatorKey: "pxa_memorandum_surveyed_property_name_present", TransactionTypeProfiles: new[] { "pe", "pxa" }),
        new PreflightRuleDefinition("pxa_memorandum_property_name_near_diagram", "memorandum", "survey_plan_memorandum", "Property name near parcel diagram", "Review whether the surveyed property name is printed near the parcel diagram when visual evidence is available.", true, "warning", false, StageId: "validate_points_and_lines", WorkflowEffect: "report_only", EvaluatorKey: "pxa_memorandum_property_name_near_diagram", TransactionTypeProfiles: new[] { "pe", "pxa" }),
        new PreflightRuleDefinition("pxa_memorandum_document_area_present", "memorandum", "survey_plan_memorandum", "Area value and unit", "Detected memorandum should provide an area value with a reviewable unit.", true, "configured", false, StageId: "validate_points_and_lines", WorkflowEffect: "requires_disposition", EvaluatorKey: "pxa_memorandum_document_area_present", TransactionTypeProfiles: new[] { "pe", "pxa" }),
        new PreflightRuleDefinition("pxa_memorandum_objections_captured", "memorandum", "survey_plan_memorandum", "Grounds of objections", "Detected memorandum should capture objections as a value, explicit None, N/A, missing, or needs-review state.", true, "configured", false, StageId: "validate_points_and_lines", WorkflowEffect: "requires_disposition", EvaluatorKey: "pxa_memorandum_objections_captured", TransactionTypeProfiles: new[] { "pe", "pxa" }),
        new PreflightRuleDefinition("pxa_memorandum_surveyor_certification_present", "memorandum", "survey_plan_memorandum", "Surveyor certification", "Detected memorandum or certification block should capture the surveyor name and certification evidence.", true, "configured", false, StageId: "validate_points_and_lines", WorkflowEffect: "requires_disposition", EvaluatorKey: "pxa_memorandum_surveyor_certification_present", TransactionTypeProfiles: new[] { "pe", "pxa" }),
        new PreflightRuleDefinition("pxa_memorandum_instrument_group_complete", "memorandum", "survey_plan_memorandum", "Instrument check evidence", "Instrument name/type, instrument check date, and instrument check result should be reviewed as one grouped memorandum finding.", true, "configured", false, StageId: "validate_points_and_lines", WorkflowEffect: "requires_disposition", EvaluatorKey: "pxa_memorandum_instrument_group_complete", TransactionTypeProfiles: new[] { "pe", "pxa" }),
        new PreflightRuleDefinition("pxa_memorandum_parish_present", "memorandum", "survey_plan_memorandum", "Parish", "Detected memorandum should provide or confirm the parish.", true, "configured", false, StageId: "validate_points_and_lines", WorkflowEffect: "requires_disposition", EvaluatorKey: "pxa_memorandum_parish_present", TransactionTypeProfiles: new[] { "pe", "pxa" }),
        new PreflightRuleDefinition("pxa_memorandum_north_arrow_present", "memorandum", "survey_plan_memorandum", "North arrow", "Map evidence should record whether a north arrow is present.", true, "warning", false, StageId: "validate_points_and_lines", WorkflowEffect: "report_only", EvaluatorKey: "pxa_memorandum_north_arrow_present", TransactionTypeProfiles: new[] { "pe", "pxa" }),
        new PreflightRuleDefinition("pxa_memorandum_scale_bar_present", "memorandum", "survey_plan_memorandum", "Scale bar", "Map evidence should record whether a scale bar is present.", true, "warning", false, StageId: "validate_points_and_lines", WorkflowEffect: "report_only", EvaluatorKey: "pxa_memorandum_scale_bar_present", TransactionTypeProfiles: new[] { "pe", "pxa" }),
        new PreflightRuleDefinition("pxa_memorandum_notice_served_on_present", "memorandum", "survey_plan_memorandum", "Notices served on", "Detected memorandum should list parties on whom notice was served.", true, "configured", false, StageId: "validate_points_and_lines", WorkflowEffect: "requires_disposition", EvaluatorKey: "pxa_memorandum_notice_served_on_present", TransactionTypeProfiles: new[] { "pe", "pxa" }),
        new PreflightRuleDefinition("pxa_memorandum_appearance_parties_present", "memorandum", "survey_plan_memorandum", "Appeared parties", "Detected memorandum should list parties who appeared personally or by representative.", true, "configured", false, StageId: "validate_points_and_lines", WorkflowEffect: "requires_disposition", EvaluatorKey: "pxa_memorandum_appearance_parties_present", TransactionTypeProfiles: new[] { "pe", "pxa" })
    }
